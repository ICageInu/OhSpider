...
public class IKScriptIt2 : MonoBehaviour
{
    //amount of chains
    ...
    private void ResolveIK()
    {
        ...
        //calc
        if ((_bones[_bones.Length-1].position - _bones[0].position).sqrMagnitude >= _completeLength * _completeLength)
        {
            ////stretch
            //Vector3 direction = (_bones[_bones.Length - 1].position - _positions[0]).normalized;
            ////set after root
