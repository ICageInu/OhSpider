...
public class BodyRaycast : MonoBehaviour
{
	...
	[SerializeField] private Transform _raycastFront = null;
	[SerializeField] private Transform _raycastBack = null;
	[SerializeField] private Transform _nose = null;
	[SerializeField] private float _angleSpeed = 2f;
